		                  ...
		                  (err,topic)=> {   switch(whichApplication)
		                  					{
		         								...
		         								/*这说明这个题目的第一志愿人是这个人*/{$push: {firststudents: this._id}},
		         																	  {new: true}).exec();
		         								break
		                  					    ...
		                  					    this.model('topics').findOneAndUpdate({_id: topicid}, 
		         								/*这说明这个题目的第二志愿人是这个人*/{$push: {secondstudents: this._id}},
		         																	  {new: true}).exec()
		                  					    break
		                  					    ...
		                  					    this.model('topics').findOneAndUpdate({_id: topicid}, 
		         								/*这说明这个题目的第三志愿人是这个人*/{$push: {thirdstudents: this._id}},
		         																	  {new: true}).exec()
		                  					    break
		                  					}
